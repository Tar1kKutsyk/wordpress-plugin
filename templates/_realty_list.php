...
<div class="ji_immoCard fusion-one-fourth fusion-layout-column fusion-spacing-yes <?php echo ($i % 4 == 0) ? 'fusion-column-last' : '' ?>" style="margin-top:0; margin-bottom:3%;">
    <div class="fusion-column-wrapper">
        <div class="ji_realty_shortlist">
            ...
            <div class="imageframe-align-center"> <span class="fusion-imageframe imageframe-none imageframe-12 hover-type-zoomin"> <a title="" class="fusion-no-lightbox" href="<?php echo $ji_api_wp_plugin->getPropertyUrl($immobilie->id); ?>"> <img class="img-responsive ji_realty_shortlist_pic" src="<?php //echo $immobilie->erstes_bild; ?><?php echo preg_replace('/(https:\/\/[^\/]*\/[^\/]*\/[^\/]*)\/[^\/]*\/(.*)/', '$1/s800x600bc/$2', $immobilie->erstes_bild); ?>"/> </a> </span> </div>
            <?php endif; ?>
            <div class="ji_immoCard_content">
                <h2> <a href="<?php echo $ji_api_wp_plugin->getPropertyUrl($immobilie->id); ?>"> <?php echo trim($immobilie->titel) != '' ? $immobilie->titel : $immobilie->id; ?> </a> </h2>
                <?php if ($immobilie->plz) : ?>
                <p> <?php echo $immobilie->plz; ?> <?php echo $immobilie->ort; ?> </p>
                <?php endif; ?>
                <p>
                ...
                <?php if ((int)$immobilie->status_id == 5 ): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <a title="" class="fusion-button button-flat button-round button-large" href="<?php echo $ji_api_wp_plugin->getPropertyUrl($immobilie->id); ?>"> Mehr Infos </a> </div>
        </div>
