  ...
  <div id="listDiv"> 
    ...
    <?php if ( is_object( $objekte ) && count( $objekte->immobilie ) > 0 ): ?>
      <div class="bg_objectSearchListHeader">
        ...
        <div style="float:left;"> Sortieren nach: <a href="<?php echo esc_url( get_permalink() . '&orderby=sort_preis' ); ?>">Preis</a> | <a href="<?php echo $ji_api_wp_plugin->getIndexUrl(); ?>&orderby=sort_flaeche">Fläche</a> | <a href="<?php echo $ji_api_wp_plugin->getIndexUrl(); ?>&orderby=ort">Ort</a> | <a href="<?php echo $ji_api_wp_plugin->getIndexUrl(); ?>&orderby=plz">PLZ</a> </div>
        <div class="clear"></div>
      </div>
      <div class="clear"></div>
      <div class="bg_objectSearchList">
          ...
          <div class="bg_objectSearchListEntry">
            <div class="bg_smallImage">
                ...
                <div class="fusion-imageframe imageframe-none imageframe-12 hover-type-zoomin"> <a class="fusion-no-lightbox" title="" href="<?php echo $ji_api_wp_plugin->getPropertyUrl( $immobilie->id ); ?>"> <img class="img-responsive ji_realty_shortlist_pic" src="<?php echo $immobilie->erstes_bild ?>"/> </a> </div>
              <?php endif; ?>
            </div>
            ...
            $tit2 = str_replace( " ", "-", (string) $immobilie->titel );
            $tit3  = str_replace( "ö", "o", (string)$tit2 );
           
            $tit =convert_chars_to_entities($tit3);
           
         
            ?>

            <div id="bg_compactInfos">
              <h2 class="bg_listTitle"> <a href="/<?php echo $ji_api_wp_plugin->getPropertyUrl( $immobilie->id ) . $tit ?>"> <?php echo trim( $immobilie->titel ) != '' ? $immobilie->titel : $immobilie->id; ?> </a> </h2>
